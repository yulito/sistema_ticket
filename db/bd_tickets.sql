...
INSERT INTO `acceso` VALUES (1,'Entrada'),(2,'Salida');
...
INSERT INTO `estado` VALUES (1,'Pendiente'),(2,'Resuelto'),(3,'En proceso');
...
CREATE TABLE `sesion` (
  ...
  KEY `sesion_access_fk` (`id_acceso`),
...
CREATE TABLE `ticket` (
  ...
  `fecsolucion` datetime DEFAULT NULL,
  `id_usuario` int NOT NULL,
